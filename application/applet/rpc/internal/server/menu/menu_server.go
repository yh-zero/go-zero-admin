...
func (s *MenuServer) UpdateAuthorityButtons(ctx context.Context, in *pb.UpdateAuthorityButtonsRequest) (*pb.NoDataResponse, error) {
	l := menulogic.NewUpdateAuthorityButtonsLogic(ctx, s.svcCtx)
	return l.UpdateAuthorityButtons(in)
}
