...
// 获取系统基础菜单列表
func (s *MenuServer) GetMenuBaseInfoList(ctx context.Context, in *pb.GetMenuBaseInfoListRequest) (*pb.GetMenuBaseInfoListResponse, error) {
	l := menulogic.NewGetMenuBaseInfoListLogic(ctx, s.svcCtx)
	return l.GetMenuBaseInfoList(in)
}

// 添加系统基础菜单列表
func (s *MenuServer) AddMenuBase(ctx context.Context, in *pb.AddMenuBaseRequest) (*pb.AddMenuBaseResponse, error) {
	l := menulogic.NewAddMenuBaseLogic(ctx, s.svcCtx)
	return l.AddMenuBase(in)
}

// 获取用户动态路由树  -- 用于角色管理的设置权限
func (s *MenuServer) GetBaseMenuTree(ctx context.Context, in *pb.GetBaseMenuTreeRequest) (*pb.GetBaseMenuTreeResponse, error) {
...
// 根据id获取菜单
func (s *MenuServer) UpdateBaseMenu(ctx context.Context, in *pb.UpdateBaseMenuRequest) (*pb.UpdateBaseMenuResponse, error) {
