...
// 添加系统基础菜单列表
func (l *AddMenuBaseLogic) AddMenuBase(in *pb.AddMenuBaseRequest) (*pb.AddMenuBaseResponse, error) {
	...
	return &pb.AddMenuBaseResponse{}, l.svcCtx.DB.Omit("deleted_at").Create(&baseMenu).Error
}
