...
type (
	...
	GetAuthorityButtonsRequest    = pb.GetAuthorityButtonsRequest
	GetAuthorityButtonsResponse   = pb.GetAuthorityButtonsResponse
	...
	SysMenu                       = pb.SysMenu
	UpdateAuthorityButtonsRequest = pb.UpdateAuthorityButtonsRequest
...
func (m *defaultMenu) GetAuthorityButtons(ctx context.Context, in *GetAuthorityButtonsRequest, opts ...grpc.CallOption) (*GetAuthorityButtonsResponse, error) {
	...
	return client.GetAuthorityButtons(ctx, in, opts...)
}

func (m *defaultMenu) UpdateAuthorityButtons(ctx context.Context, in *UpdateAuthorityButtonsRequest, opts ...grpc.CallOption) (*NoDataResponse, error) {
	client := pb.NewMenuClient(m.cli.Conn())
	return client.UpdateAuthorityButtons(ctx, in, opts...)
}
