...
INSERT INTO `casbin_rule` VALUES (62, 'p', '10', '/v1/sys/api/createApi', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES (63, 'p', '10', '/v1/sys/api/deleteApi', 'DELETE', '', '', '');
INSERT INTO `casbin_rule` VALUES (65, 'p', '10', '/v1/sys/api/deleteApisByIds', 'DELETE', '', '', '');
INSERT INTO `casbin_rule` VALUES (64, 'p', '10', '/v1/sys/api/getAllApiList', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (61, 'p', '10', '/v1/sys/api/getApiList', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (66, 'p', '10', '/v1/sys/api/updateApi', 'PUT', '', '', '');
INSERT INTO `casbin_rule` VALUES (57, 'p', '10', '/v1/sys/authority/addAuthorityMenu', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES (59, 'p', '10', '/v1/sys/authority/createAuthority', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES (60, 'p', '10', '/v1/sys/authority/deleteAuthority', 'DELETE', '', '', '');
INSERT INTO `casbin_rule` VALUES (56, 'p', '10', '/v1/sys/authority/getAuthorityList', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (58, 'p', '10', '/v1/sys/authority/updateAuthority', 'PUT', '', '', '');
INSERT INTO `casbin_rule` VALUES (80, 'p', '10', '/v1/sys/base/uploadFileImg', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES (77, 'p', '10', '/v1/sys/casbin/getPathByAuthorityId', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (78, 'p', '10', '/v1/sys/casbin/updateCasbinData', 'PUT', '', '', '');
INSERT INTO `casbin_rule` VALUES (79, 'p', '10', '/v1/sys/casbin/updateCasbinDataByApiIds', 'PUT', '', '', '');
INSERT INTO `casbin_rule` VALUES (47, 'p', '10', '/v1/sys/deleteUser', 'DELETE', '', '', '');
INSERT INTO `casbin_rule` VALUES (68, 'p', '10', '/v1/sys/dictionary/createSysDictionary', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES (75, 'p', '10', '/v1/sys/dictionary/createSysDictionaryInfo', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES (71, 'p', '10', '/v1/sys/dictionary/deleteSysDictionary', 'DELETE', '', '', '');
INSERT INTO `casbin_rule` VALUES (76, 'p', '10', '/v1/sys/dictionary/deleteSysDictionaryInfo', 'DELETE', '', '', '');
INSERT INTO `casbin_rule` VALUES (69, 'p', '10', '/v1/sys/dictionary/getSysDictionaryDetails', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (72, 'p', '10', '/v1/sys/dictionary/getSysDictionaryInfoList', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (73, 'p', '10', '/v1/sys/dictionary/getSysDictionaryInfoListDetailsById', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (67, 'p', '10', '/v1/sys/dictionary/getSysDictionaryList', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (70, 'p', '10', '/v1/sys/dictionary/updateSysDictionary', 'PUT', '', '', '');
INSERT INTO `casbin_rule` VALUES (74, 'p', '10', '/v1/sys/dictionary/updateSysDictionaryInfo', 'PUT', '', '', '');
INSERT INTO `casbin_rule` VALUES (43, 'p', '10', '/v1/sys/getUserList', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (41, 'p', '10', '/v1/sys/login', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES (50, 'p', '10', '/v1/sys/menu/addBaseMenu', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES (55, 'p', '10', '/v1/sys/menu/deleteBaseMenu', 'DELETE', '', '', '');
INSERT INTO `casbin_rule` VALUES (53, 'p', '10', '/v1/sys/menu/getBaseMenuById', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (51, 'p', '10', '/v1/sys/menu/getBaseMenuTree', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (48, 'p', '10', '/v1/sys/menu/getMenu', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (52, 'p', '10', '/v1/sys/menu/getMenuAuthority', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (49, 'p', '10', '/v1/sys/menu/getMenuList', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (54, 'p', '10', '/v1/sys/menu/updateBaseMenu', 'PUT', '', '', '');
INSERT INTO `casbin_rule` VALUES (42, 'p', '10', '/v1/sys/randomImage', 'GET', '', '', '');
INSERT INTO `casbin_rule` VALUES (44, 'p', '10', '/v1/sys/register', 'POST', '', '', '');
INSERT INTO `casbin_rule` VALUES (46, 'p', '10', '/v1/sys/resetUserPassword', 'PUT', '', '', '');
INSERT INTO `casbin_rule` VALUES (45, 'p', '10', '/v1/sys/updateUserInfo', 'PUT', '', '', '');
...
-- ----------------------------
INSERT INTO `sys_authorities` VALUES ('2024-01-15 13:14:52.000', '2024-01-16 17:24:41.743', NULL, 1, '超级用户', 0, 'authority');
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = REDUNDANT;
...
-- ----------------------------
INSERT INTO `sys_users` VALUES (1, '2024-01-10 11:54:46.167', '2024-01-10 11:54:46.167', NULL, 'e2ab86b1-8e3d-4864-80ad-e83131353686', 'admin', '$2a$10$0tL51xscR4JV7RQCz34Wc.uYDLuGQdovS9XCXAderJEG7TmkDVi2m', 'Mr.root', 'dark', '', '#000', '#fff', 1, '15888888888', 'TypeScript@111.com', 1);
INSERT INTO `sys_users` VALUES (2, '2024-01-10 09:27:22.905', '2024-01-16 17:02:30.003', NULL, 'e2ab86b1-8e3d-4864-80ad-e83131353686', 'yanghao', '$2a$10$0tL51xscR4JV7RQCz34Wc.uYDLuGQdovS9XCXAderJEG7TmkDVi2m', 'Mr.杨浩', 'dark', '', '#000', '#fff', 10, '15888888888', 'TypeScript@111.com', 1);
INSERT INTO `sys_users` VALUES (3, '2024-01-10 09:26:44.047', '2024-01-10 09:26:44.047', NULL, 'e2ab86b1-8e3d-4864-80ad-e83131353686', 'wenlong', '$2a$10$0tL51xscR4JV7RQCz34Wc.uYDLuGQdovS9XCXAderJEG7TmkDVi2m', 'Mr.文龙', 'dark', '', '#000', '#1890ff', 1, '15888888888', 'TypeScript@111.com', 1);
